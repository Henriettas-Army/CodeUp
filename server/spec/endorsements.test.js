...
describe('endorsement creation', () => {
  ...
  const endorsement = {
    endorsee: 'Fliko',
    endorserToken: 'eyJhbGciOiJIUzI1NiJ9.dGVjaG1leGRldg.9-fvxZx-pXGspIscUx2ZYW3tD7BZiVS0rygiq8LQ_Lo',
    title: 'A title',
  ...
  test('user cannot endorse him/herself', async () => {
    expect.assertions(1);
    const flikoToken = 'eyJhbGciOiJIUzI1NiJ9.Rmxpa28.pDCHKc-g6CAt5MzSmucQpH7GYBeWrcvjDxKSgk2Qj8w';
